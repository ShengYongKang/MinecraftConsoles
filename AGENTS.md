...
- When the task involves OurEra runtime profiles, benchmark JSON, Godot CLI log files, route profiling, or temporary analysis artifacts, always use `$ourera-runtime-artifacts` for that turn.
